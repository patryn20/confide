<form method="POST" action="{{{ Confide::checkAction( Confide::controllerName() . '@do_login') ?: URL::to('/' . Config::get('auth.table') . '/login') }}}" accept-charset="UTF-8">
    ...
    <fieldset>
        ...
        <label for="password">
            ...
            <small>
                <a href="{{{ (Confide::checkAction( Confide::controllerName() . '@forgot_password')) ?: 'forgot' }}}">{{{ Lang::get('confide::confide.login.forgot_password') }}}</a>
            </small>
        </label>
