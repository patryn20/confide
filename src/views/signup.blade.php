<form method="POST" action="{{{ (Confide::checkAction( ucfirst(Config::get('confide::controller_prefix')) . Config::get('auth.model') . 'Controller@store')) ?: URL::to(Config::get('auth.table'))  }}}" accept-charset="UTF-8">
